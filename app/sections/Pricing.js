...
const PriceCard = ({ title, price, features, isPopular, period, onGetStarted, userRange, monthlyPrice, annualPrice, promoPrice }) => {
  const isPersonalPlan = title === "Personal Plan";

  return (
    <div className={`relative rounded-2xl p-8 ${isPopular ? 'bg-blue-50 border-2 border-[#3981a2]' : 'bg-white border border-gray-200'
      }`}>
      {isPopular && (
      ...
      <Button
        ...
        className={`w-full py-2 rounded-lg transition-all duration-200 ${isPersonalPlan
...
const Pricing = () => {
  ...
  return (
    <>
      <section className="pt-20 pb-5 bg-gray-50" id="pricing">
              ...
              <div className="flex justify-center items-center gap-4 mb-16">
                <div className="flex p-1 bg-gray-200 rounded-full">
                  <Button
                    ...
                    className={`px-4 py-2 rounded-full transition-all duration-300 ${billingPeriod === 'monthly'
                  ...
                  <Button
                    ...
                    className={`px-4 py-2 rounded-full transition-all duration-300 ${billingPeriod === 'yearly'
                        ? 'primary-btn-round rounded-full text-white shadow-sm scale-105'
                        : 'bg-transparent text-gray-600 hover:text-gray-900'
                      }`}
                  >
